    ...
    <Layout>
      ...
      <S.Main>
        ...
        <Container>
          <S.Section>
            <p>
              I read about the job position on the Fronteers Slack, but the
              first time I read about Orchest it was on /r/selfhosted. I'm a
              huge selfhosted fan (I enjoy the podcast from Jupiter Broadcasting
              as well) and I'm just starting out with my own homelab at the
              moment.
            </p>

            <p>
              It's great that you are building an open source software with a
              'open core' model. Although they have pro and cons, as a big open
              source user myself I like running these kinds of projects on my
              own homelab or on a VPS. I use Ubuntu as my main desktop distro
              and try to use open source as much as possible.
            </p>

            <p>
              I've downloaded Orchest and it's pulling the images as I type, but
              it looks like it might take a while and I want to share my CV with
              you to get the conversation going. By the time we speak, I'll have
              given it a spin.
            </p>

            <p>
              I'm specialized in front-end development, but I am pretty much
              T-shaped. I enjoy DevOps and back-end development as well, and
              like designing interfaces straight in the browser.
            </p>
          </S.Section>
          <CV />
          <Cases>
            <header>
              ...
              <p>
                ...
                Orchest in some way. It could be because they showcase the tech
                stack you are looking for, it might be because they're bigger
                projects with a lot of customers or visitors, or they might be
                projects where I've taken on lead roles.
              </p>
            </header>
            <Case
